...
func getPage(page int, baseURL string, mainC chan<- []extractedJob) {
	...
	fmt.Println("Requesting to ...", pageURL)
...
func extractJob(card *goquery.Selection, c chan<- extractedJob) {
	...
	title := CleanStrings(card.Find(".title>a").Text())
	location := CleanStrings(card.Find(".sjcl").Text())
	salary := CleanStrings(card.Find(".salaryText").Text())
